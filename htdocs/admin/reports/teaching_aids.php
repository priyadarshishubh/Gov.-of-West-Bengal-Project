...
<div class="content-container">
    ...
    if (isset($_POST["submit"]) && isset($_POST["NCVT_MIS_code"]) && isset($_POST["month"]) && isset($_POST["year"])) {
        ...
        $sql = "SELECT * FROM `teaching_aids_monitoring`";
    }
    ?>
    ...
    if (isset($_POST["submit"])) {
        ...
        <div style="position: absolute; right: 5%; margin-bottom: 5%;" class="dropdown">
            ...
            <div class="dropdown-content">
                <a href="/admin/print/print_teaching_aids.php?doc=pdf&NCVT_MIS_code=<?php echo $NCVT_MIS_code;?>&month=<?php echo $month;?>&year=<?php echo $year;?>">PDF</a>
                <a href="/admin/print/print_teaching_aids.php?doc=excel&NCVT_MIS_code=<?php echo $NCVT_MIS_code;?>&month=<?php echo $month;?>&year=<?php echo $year;?>">EXCEL</a>
            </div>
        </div>
        <br>
        <br><br><br><br>
...
//    if (isset($_POST["submit"])) {
//        ?>
<!--        <form align="center" style="display: block;" method="post" action="/admin/print/print_teaching_aids.php?NCVT_MIS_code=--><?php //echo $_POST["NCVT_MIS_code"];?><!--&month=--><?php //echo $_POST["month"];?><!--&year=--><?php //echo $_POST["year"];?><!--">-->
