...
//        ?>
<!--        <form align="center" style="display: block;" method="post" action="/admin/print/print_trade_allocation.php?NCVT_MIS_code=--><?php //echo $_POST["NCVT_MIS_code"];?><!--">-->
    ...
    if (isset($_POST["submit"])) {
        ...
        <div style="position: absolute; right: 5%; margin-bottom: 5%;" class="dropdown">
            ...
            <div class="dropdown-content">
                <a href="/admin/print/print_trade_allocation.php?doc=pdf&NCVT_MIS_code=<?php echo $NCVT_MIS_code;?>">PDF</a>
                <a href="/admin/print/print_trade_allocation.php?doc=excel&NCVT_MIS_code=<?php echo $NCVT_MIS_code;?>">EXCEL</a>
            </div>
        </div>
        <br>
        <br><br><br>
        ...
        <div class="table-horizontal-container">
            <table class="unfixed-table">
                ...
                <tr>
                    ...
                    <td><a class="green-btn" href="/admin/trade-allocation/trade_map_edit.php?unique_id=<?php echo $data['unique_id']; ?>">Edit</a> /
                        <a class="green-btn redhover" href="/admin/trade-allocation/trade_map_delete_back.php?unique_id=<?php echo $data['unique_id']; ?>&NCVT_MIS_code=<?php echo $data['NCVT_MIS_code']; ?>">Delete</a> </td>
                </tr>
                <?php
                }
                ?>
