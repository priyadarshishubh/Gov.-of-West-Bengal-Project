...
<div class="content-container">
    ...
    <div style="position: absolute; right: 5%; margin-bottom: 5%;" class="dropdown">
        ...
        <div class="dropdown-content">
            <a href="/admin/print/print_trade.php?doc=pdf">PDF</a>
            <a href="/admin/print/print_trade.php?doc=excel">EXCEL</a>
        </div>
    </div>
    <br>
    <br><br><br><br>

<!--    <form align="center" style="display: block;" method="post" action="/admin/print/print_trade.php">-->
        ...
        <div class="table-horizontal-container">
            <table style="" class="unfixed-table">
                ...
                <tr>
                    ...
                    <td><a class="green-btn" href="/admin/trade/trade_edit.php?trade_code=<?php echo $data['trade_code']; ?>">Edit</a> /
                        <a class="green-btn redhover" href="/admin/trade/trade_delete_back.php?trade_code=<?php echo $data['trade_code']; ?>">Delete</a> </td>
                </tr>
                <?php
                }
                ?>
