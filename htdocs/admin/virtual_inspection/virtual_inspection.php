...
<div class="content-container">
    ...
    if ((isset($_POST["submit"]) && isset($_POST["NCVT_MIS_code"]) && isset($_POST["month"]) && isset($_POST["year"])) ||
        (isset($_REQUEST["NCVT_MIS_code"]) && isset($_REQUEST["month"]) && isset($_REQUEST["year"])) ) {
        ...
        $sql = "SELECT * FROM `virtual_inspection` where `NCVT_MIS_code`='$NCVT_MIS_code' and `month`='$month' and `year`='$year';";
    ...
    ?>
        ...
        <td style="">
            ...
            <div align="center">
                ...
                <a  style="text-decoration: none; padding: 3px 5px; color: white; background-color:red;" href="/admin/virtual_inspection/virtual_inspection_delete_back.php?unique_id=<?php echo $data['unique_id']; ?>&NCVT_MIS_code=<?php echo $data['NCVT_MIS_code']; ?>&month=<?php echo $data['month']; ?>&year=<?php echo $data['year']; ?>">Delete</a>
                </button>
            </div>
        </td>
                    <?php
