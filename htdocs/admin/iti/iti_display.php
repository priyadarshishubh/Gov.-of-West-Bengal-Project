    ...
    <h2 align="center" style="color: #a2a2a2; font-weight: bold;">ITI Table</h2>
        ...
        <div style="position: absolute; right: 5%; margin-bottom: 5%;" class="dropdown">
            ...
            <div class="dropdown-content">
                <a href="/admin/print/print_iti.php?doc=pdf">PDF</a>
                <a href="/admin/print/print_iti.php?doc=excel">EXCEL</a>
            </div>
        </div>
        <br>
        <br><br><br><br>
        ...
        <div class="table-horizontal-container">
            <table class="unfixed-table">
                ...
                <tr>
                    ...
                    <td><a class="green-btn" href="/admin/iti/iti_edit.php?NCVT_MIS_code=<?php echo $data['NCVT_MIS_code']; ?>">Edit</a> /
                        <a class="green-btn redhover" href="/admin/iti/iti_delete_back.php?NCVT_MIS_code=<?php echo $data['NCVT_MIS_code']; ?>">Delete</a> </td>
                </tr>
                </tbody>
                <?php
                }
