...
<div class="content-container">
    ...
    if (isset($_POST["submit"]) && isset($_POST["month"]) && isset($_POST["year"])) {
        ...
        $month = $_POST["month"];
        $year = $_POST["year"];
        $sql = "SELECT * FROM `assessment_monitoring` where `NCVT_MIS_code`='$id' and `month`='$month' and `calendar_year`='$year' order by `trade_code` asc;";
    }
    else {
        $sql = "SELECT * FROM `assessment_monitoring` where `NCVT_MIS_code`='$id' order by `trade_code` ASC;";
    }
    ...
    if (isset($_POST["submit"])) {
        ...
        <div style="position: absolute; right: 5%; margin-bottom: 5%;" class="dropdown">
            ...
            <div class="dropdown-content">
                <a href="/iti_spoc/print/print_assessment.php?doc=pdf&NCVT_MIS_code=<?php echo $NCVT_MIS_code;?>&month=<?php echo $month;?>&year=<?php echo $year;?>">PDF</a>
                <a href="/iti_spoc/print/print_assessment.php?doc=excel&NCVT_MIS_code=<?php echo $NCVT_MIS_code;?>&month=<?php echo $month;?>&year=<?php echo $year;?>">EXCEL</a>
            </div>
        </div>
        <br>
        ...
        <div class="table-horizontal-container">
            <table class="unfixed-table">
                ...
                <tr>
                    ...
                    <th>Marks Obtained in Employability Skills</th><th>Total Marks in Employability Skills</th><th>Options</th>
                </tr>
                </thead>
                <tbody>
                <?php
                while($data=mysqli_fetch_array($result))
                {
                    ...
                    <tr>
                        ...
                        ?>
                        <td><a class="green-btn" href="/iti_spoc/reports/edit_assessment.php?unique_id=<?php echo $data['unique_id']; ?>">Edit</a> /
                        <a class="green-btn redhover" href="/iti_spoc/reports/delete_assessment_back.php?unique_id=<?php echo $data['unique_id']; ?>">Delete</a> </td>
                    </tr>
                    <?php
                }
                ?>
